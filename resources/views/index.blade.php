...
<div class="navbar navbar-default navbar-static-top" role="navigation">
     <div class="container">
          ...
          <div class="navbar-header">
               ...
               <a href="/" class="navbar-brand">杨黏糊</a>
               <p class="tagline">世界著名冷笑话表演艺术家</p>
          </div>
     ...
     <div class="container">
          <div class="row">
               ...
               <div class="col-md-12 col-sm-12">
                    <h1>Welcome.</h1>
                    <h4>my blog</h4>
                    <a href="/article" class="smoothScroll btn btn-default">Discover More</a>
               </div>
...
<script src="js/index/jquery.parallax.js"></script>
